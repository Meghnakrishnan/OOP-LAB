...
void area(double l,double b){						//METHOD area WITH TWO  PARAMETER
	 System.out.println("Area of rectangle having length 3 and breadth 4 is : "+ l*b );    //CALCULATE AREA OF RECTANGLE
...
Area of triangle having base 3 and height 5 is : 6.0
